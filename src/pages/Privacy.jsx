    ...
    <React.Fragment>
      ...
      <div className="px-40 py-20">
        ...
        <p>
          ...
          collect the data shown in the comments form, and also the visitor’s IP
        ...
        <p>
          ...
          http://automattic.com/privacy/. After approval of your comment, your
          profile picture is visible to the public in the context of your
          comment.
        </p>
        <h2>Media</h2>
        <p>
          <b>Suggested text:</b> If you upload images to the website, you should
        ...
        <h2>Cookies</h2>
        <p>
          <b>Suggested text:</b> If you leave a comment on our site you may
          opt-in to saving your name, email address and website in cookies.
          These are for your convenience so that you do not have to fill in your
          details again when you leave another comment. These cookies will last
          for one year.
        </p>
        <p>
        ...
        <p>
          <b>Suggested text:</b> Articles on this site may include embedded
          content (e.g. videos, images, articles, etc.). Embedded content from
          other websites behaves in the exact same way as if the visitor has
        ...
        <p>
          <b>Suggested text:</b> If you request a password reset, your IP
          address will be included in the reset email.
        </p>
        <h2>How long we retain your data</h2>
        <p>
          <b>Suggested text:</b> If you leave a comment, the comment and its
          metadata are retained indefinitely. This is so we can recognize and
          approve any follow-up comments automatically instead of holding them
        ...
        <p>
          <b>Suggested text:</b> If you have an account on this site, or have
          left comments, you can request to receive an exported file of the
          personal data we hold about you, including any data you have provided
        ...
        <p>
          <b>Suggested text:</b> Visitor comments may be checked through an
