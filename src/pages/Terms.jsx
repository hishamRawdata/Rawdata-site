...
const Terms = () => {
  return (
    <React.Fragment>
      <SEO title="Rawdata || Terms and Conditions" />
      <Header />
      <div
      ...
      <div className="px-lg-40 px-2 px-md-15 py-20">
        ...
        <p>
          ...
          use of Rawdata&apos;s website, located at [https://rawdatatech.com/].
        </p>
        <p>
          By accessing this website, we assume you accept these terms and
          conditions. Do not continue to use Rawdata’s website if you do not
        ...
        <p>
          ...
          the person logged on to this website and compliant with the
          ...
          Client most appropriately for the express purpose of meeting the
          Client&apos;s needs in respect of the provision of the Company&apos;s
          stated services, per and subject to, prevailing law of [Country]. Any
        ...
        <h5>Cookies</h5>
        <p>
          We employ the use of cookies. By accessing Rawdata's website, you
          agree to use cookies in agreement with Rawdata's Privacy Policy.
        </p>
        <p>
        ...
        <h5>License</h5>
        <p>
          Unless otherwise stated, Rawdata and/or its licensors own the
          intellectual property rights for all material on Rawdata. All
          intellectual property rights are reserved. You may access this from
          Rawdata for your own personal use subject to restrictions set in these
          terms and conditions.
        </p>
        <p>
          You must not:
          <ul style={{ listStyleType: "none" }}>
            <li>- Republish material from Rawdata</li>
            <li>- Sell, rent or sub-license material from Rawdata</li>
            <li>- Reproduce, duplicate or copy material from Rawdata</li>
            <li>- Redistribute content from Rawdata</li>
          </ul>
        </p>
        ...
        <p>
          ...
          types of organizations: <br />- commonly-known consumer and/or
          business information sources;
          <br /> - dot.com community sites; <br /> - associations or other
          groups representing charities; <br /> - online directory distributors;
          <br /> - internet portals;
        ...
        <p>
          ...
          the hyperlink compensates the absence of Rawdata; and (d) the link is
        ...
        <p>
          ...
          sending an e-mail to Rawdata. Please include your name, your
        ...
        <p>
          ...
          - By use of our corporate name; or <br /> - By use of the uniform
          resource locator being linked to; or - By use of any other description
          of our Website being linked to that makes sense within the context and
          format of content on the linking party's site.{" "}
        </p>
        <p>
          No use of Rawdata's logo or other artwork will be allowed for linking
        ...
        <p>
          ...
          and the use of this website. Nothing in this disclaimer will: <br /> -
          limit or exclude our or your liability for death or personal injury;{" "}
          <br /> - limit or exclude our or your liability for fraud or
